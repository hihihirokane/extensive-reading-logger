...
(多読のやりかたによっては)
有用かもしれない。数字との対応は酒井邦秀『快読100万語』に倣った。
 <!-- UN*X コマンド ```tail,head,grep``` と併用するか、 -->
* ```./mktable.awk``` WPMが若干ファンシーに表示される。
* ```./mktable.awk -w``` 画面を保存する。

速度|WPMの色|意味
-----------------|-------------|------
200-|![#00ffff](https://placehold.it/15/00ffff/000000?text=+) `#00ffff`|簡単すぎる
150-200|![#005fff](https://placehold.it/15/005fff/000000?text=+) `#005fff`|十分に速いので、レベルを上げてよい
100-150|無色|このレベルが現在の訓練に適している
75-100|![#ffff00](https://placehold.it/15/ffff00/000000?text=+) `#ffff00`|やや遅いので、レベル下げを検討すべき
-75|![#ff0000](https://placehold.it/15/ff0000/000000?text=+) `#ff0000`|難しすぎる
